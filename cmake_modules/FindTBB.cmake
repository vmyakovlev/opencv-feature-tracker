...
if (UNIX)
    if (APPLE)
        ...
        message(STATUS "Finding TBB for Linux")
        # LINUX
        ...
        set(_TBB_ARCHITECTURE $ENV{TBB30_ARCH})

            message(STATUS "TBB Install dir: " $ENV{TBB30_INSTALL_DIR})
        if (NOT "$ENV{TBB30_INSTALL_DIR}" STREQUAL "")
            SET(TBB_INSTALL_DIR $ENV{TBB30_INSTALL_DIR})
            message(STATUS "TBB Install dir: " ${TBB_INSTALL_DIR})
        endif (NOT "$ENV{TBB30_INSTALL_DIR}" STREQUAL "")

        message(STATUS "Install dir: " ${TBB_INSTALL_DIR})
        message(STATUS "Compiler" ${_TBB_COMPILER})
        message(STATUS "Architecture" ${_TBB_ARCHITECTURE})
...
message(STATUS "Finding TBB installation directory")
...
# Hack
if(LINUX)
    set (TBB_LIBRARY_DIR "${_TBB_INSTALL_DIR}/lib/$ENV{TBB30_TYPE}/${_TBB_ARCHITECTURE}")
endif(LINUX)
...
message(STATUS "Setting up TBB variables")
